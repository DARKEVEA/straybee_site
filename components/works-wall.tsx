...
export const WorksWall = ({ locale, works, labels }: WorksWallProps) => {
  ...
  const visibleWorks = filteredWorks.slice((currentPage - 1) * pageSize, currentPage * pageSize);
  ...
  return (
    <section id="works" className="mt-24 space-y-8">
      ...
      {selectedWork
        ? createPortal(
            <div
              className="fixed left-0 top-0 z-[120] flex h-[100dvh] w-screen items-center justify-center bg-industrial/85 p-4"
